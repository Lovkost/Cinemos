package com.example.cinemos.ui.main.adapters
...
import com.example.cinemos.ui.main.views.HomeFragment
...
class MainFragmentAdapter(private var onItemViewClickListener: HomeFragment.OnItemViewClickListener?) :
    ...
    inner class MainViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movieData: FactDTO) {
            if (FilterFragment().loadPref(IS_ADULT_KEY) or !movieData.adult) {
                val link = "https://www.themoviedb.org/t/p/w600_and_h900_bestv2"
                val imageView =
                    itemView.findViewById<ImageView>(R.id.mainFragmentRecyclerView_image)
                itemView.findViewById<TextView>(R.id.mainFragmentRecyclerViewTextView).text =
